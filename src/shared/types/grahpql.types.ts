...
/** Input for the createDressing mutation. */
export type CreateDressingInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars['String']['input']>;
...
/** The payload for the createDressing mutation. */
export type CreateDressingPayload = {
  __typename?: 'CreateDressingPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  dressing?: Maybe<Dressing>;
};
...
/** Input for the createJournal mutation. */
...
/** The payload for the createJournal mutation. */
...
/** Input for the createLounge mutation. */
...
/** The payload for the createLounge mutation. */
export type CreateLoungePayload = {
  __typename?: 'CreateLoungePayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  lounge?: Maybe<Lounge>;
...
export type CreatePavilionInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars['String']['input']>;
...
/** The payload for the createPavilion mutation. */
export type CreatePavilionPayload = {
  __typename?: 'CreatePavilionPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
...
/** Input for the deleteDressing mutation. */
export type DeleteDressingInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the dressing to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deleteDressing mutation. */
export type DeleteDressingPayload = {
  __typename?: 'DeleteDressingPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
/** Input for the deleteJournal mutation. */
...
/** The payload for the deleteJournal mutation. */
...
/** Input for the deleteLounge mutation. */
export type DeleteLoungeInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the lounge to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deleteLounge mutation. */
export type DeleteLoungePayload = {
  __typename?: 'DeleteLoungePayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
export type DeletePavilionInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the pavilion to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deletePavilion mutation. */
export type DeletePavilionPayload = {
  __typename?: 'DeletePavilionPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
/** The dressing type */
export type Dressing = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Dressing';
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Поля гримёрки&quot; was set to Show in GraphQL. */
  acfDressingFields?: Maybe<Dressing_Acfdressingfields>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  /** The name of the Content Type the node belongs to */
  contentTypeName: Scalars['String']['output'];
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** The globally unique identifier of the dressings object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Content Node */
  isContentNode: Scalars['Boolean']['output'];
  /** Whether the object is a node in the preview state */
  ...
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']['output']>;
  /** Connection between the Dressing type and the dressing type */
  preview?: Maybe<DressingToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
...
/** The dressing type */
export type DressingEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The dressing type */
export type DressingEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The dressing type */
export type DressingTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Connection to dressing Nodes */
export type DressingConnection = {
  /** A list of edges (relational context) between RootQuery and connected dressing Nodes */
  edges: Array<DressingConnectionEdge>;
  /** A list of connected dressing Nodes */
  nodes: Array<Dressing>;
  /** Information about pagination in a connection. */
  pageInfo: DressingConnectionPageInfo;
};

/** Edge between a Node and a connected dressing */
export type DressingConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected dressing Node */
  node: Dressing;
};

/** Page Info on the connected DressingConnectionEdge */
export type DressingConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Dressing type and the dressing type */
export type DressingToPreviewConnectionEdge = DressingConnectionEdge & Edge & OneToOneConnection & {
  __typename?: 'DressingToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Dressing;
...
/** Field Group */
export type Dressing_Acfdressingfields = AcfFieldGroup & {
...
/** The equipment type */
export type Equipment = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Equipment';
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Поля техники&quot; was set to Show in GraphQL. */
  acfEquipmentFields?: Maybe<Equipment_Acfequipmentfields>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  /** The name of the Content Type the node belongs to */
  contentTypeName: Scalars['String']['output'];
...
/** Connection to equipment Nodes */
export type EquipmentConnection = {
  /** A list of edges (relational context) between RootQuery and connected equipment Nodes */
  edges: Array<EquipmentConnectionEdge>;
  /** A list of connected equipment Nodes */
  nodes: Array<Equipment>;
  /** Information about pagination in a connection. */
  pageInfo: EquipmentConnectionPageInfo;
};

/** Edge between a Node and a connected equipment */
export type EquipmentConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected equipment Node */
  node: Equipment;
};

/** Page Info on the connected EquipmentConnectionEdge */
export type EquipmentConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Equipment type and the equipment type */
export type EquipmentToPreviewConnectionEdge = Edge & EquipmentConnectionEdge & OneToOneConnection & {
...
/** Field Group */
export type Equipment_Acfequipmentfields = AcfFieldGroup & {
  __typename?: 'Equipment_Acfequipmentfields';
  content?: Maybe<Scalars['String']['output']>;
  contentalignhorizontal?: Maybe<Scalars['String']['output']>;
  contentalignvertical?: Maybe<Scalars['String']['output']>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
...
export type GeneralSettings = {
  ...
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Поля настроек сайта&quot; was set to Show in GraphQL. */
  acfSettings?: Maybe<GeneralSettings_Acfsettings>;
  pageSlug?: Maybe<Scalars['String']['output']>;
  pageTitle?: Maybe<Scalars['String']['output']>;
};

/** Field Group */
export type GeneralSettings_Acfsettings = AcfFieldGroup & {
...
/** Field Group */
export type GeneralSettings_Acfsettings_Documents = AcfFieldGroup & {
  __typename?: 'GeneralSettings_Acfsettings_documents';
  documentfile?: Maybe<MediaItem>;
...
export type Journal = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithComments & NodeWithContentEditor & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  ...
  preview?: Maybe<JournalToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
...
/** The journal type */
export type JournalContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The journal type */
export type JournalEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The journal type */
export type JournalEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The journal type */
export type JournalTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Connection to journal Nodes */
export type JournalConnection = {
  /** A list of edges (relational context) between RootQuery and connected journal Nodes */
  edges: Array<JournalConnectionEdge>;
  /** A list of connected journal Nodes */
  nodes: Array<Journal>;
  /** Information about pagination in a connection. */
  pageInfo: JournalConnectionPageInfo;
};

/** Edge between a Node and a connected journal */
export type JournalConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected journal Node */
  node: Journal;
};

/** Page Info on the connected JournalConnectionEdge */
export type JournalConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
export type JournalToPreviewConnectionEdge = Edge & JournalConnectionEdge & OneToOneConnection & {
  __typename?: 'JournalToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Journal;
...
/** The lounge type */
export type Lounge = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Lounge';
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Поля зала&quot; was set to Show in GraphQL. */
  acfLoungeFields?: Maybe<Lounge_Acfloungefields>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  /** The name of the Content Type the node belongs to */
  contentTypeName: Scalars['String']['output'];
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** The globally unique identifier of the lounges object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Content Node */
  isContentNode: Scalars['Boolean']['output'];
  /** Whether the object is a node in the preview state */
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  loungeId: Scalars['Int']['output'];
  /** The local modified time for a post. If a post was recently updated the modified field will change to match the corresponding time. */
  modified?: Maybe<Scalars['String']['output']>;
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']['output']>;
  /** Connection between the Lounge type and the lounge type */
  preview?: Maybe<LoungeToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
...
/** The lounge type */
export type LoungeEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The lounge type */
export type LoungeEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** Connection to lounge Nodes */
export type LoungeConnection = {
  /** A list of edges (relational context) between RootQuery and connected lounge Nodes */
  edges: Array<LoungeConnectionEdge>;
  /** A list of connected lounge Nodes */
  nodes: Array<Lounge>;
  /** Information about pagination in a connection. */
  pageInfo: LoungeConnectionPageInfo;
};

/** Edge between a Node and a connected lounge */
export type LoungeConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected lounge Node */
  node: Lounge;
};

/** Page Info on the connected LoungeConnectionEdge */
export type LoungeConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Lounge type and the lounge type */
export type LoungeToPreviewConnectionEdge = Edge & LoungeConnectionEdge & OneToOneConnection & {
  __typename?: 'LoungeToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Lounge;
...
/** Field Group */
export type Lounge_Acfloungefields = AcfFieldGroup & {
  __typename?: 'Lounge_Acfloungefields';
...
export type Lounge_Acfloungefields_Exampleslider = AcfFieldGroup & {
  __typename?: 'Lounge_Acfloungefields_exampleslider';
...
/** Field Group */
export type Lounge_Acfloungefields_Layoutproperties = AcfFieldGroup & {
  __typename?: 'Lounge_Acfloungefields_layoutproperties';
  content?: Maybe<Scalars['String']['output']>;
  excerpt?: Maybe<Scalars['String']['output']>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
...
export type MenuItemObjectUnion = Category | Dressing | Equipment | Event | Journal | Lounge | Page | Partner | Pavilion | Post | Tag;
...
export type Page = ContentNode & DatabaseIdentifier & HierarchicalContentNode & HierarchicalNode & MenuItemLinkable & Node & NodeWithAuthor & NodeWithComments & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithPageAttributes & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Page';
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Поля страницы &quot;Контакты&quot;&quot; was set to Show in GraphQL. */
  ...
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Поля страницы &quot;Цены&quot;&quot; was set to Show in GraphQL. */
  acfPriceFields?: Maybe<Page_Acfpricefields>;
  /** Returns ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  ancestors?: Maybe<HierarchicalContentNodeToContentNodeAncestorsConnection>;
  /** Connection between the NodeWithAuthor type and the User type */
  author?: Maybe<NodeWithAuthorToUserConnectionEdge>;
...
/** Field Group */
export type Page_Acfcontactsfields = AcfFieldGroup & {
  __typename?: 'Page_Acfcontactsfields';
...
/** Field Group */
export type Page_Acfpricefields = AcfFieldGroup & {
  __typename?: 'Page_Acfpricefields';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  pricefile?: Maybe<MediaItem>;
  priceimage?: Maybe<MediaItem>;
  pricetitle?: Maybe<Scalars['String']['output']>;
};
...
export type Pavilion = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Pavilion';
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Поля павильона&quot; was set to Show in GraphQL. */
  acfPavilionFields?: Maybe<Pavilion_Acfpavilionfields>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  /** The name of the Content Type the node belongs to */
  contentTypeName: Scalars['String']['output'];
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** The globally unique identifier of the pavilions object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Content Node */
  isContentNode: Scalars['Boolean']['output'];
  /** Whether the object is a node in the preview state */
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  pavilionId: Scalars['Int']['output'];
  /** Connection between the Pavilion type and the pavilion type */
  preview?: Maybe<PavilionToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
...
/** The pavilion type */
export type PavilionEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The pavilion type */
export type PavilionEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The pavilion type */
export type PavilionTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Connection to pavilion Nodes */
export type PavilionConnection = {
  /** A list of edges (relational context) between RootQuery and connected pavilion Nodes */
  edges: Array<PavilionConnectionEdge>;
  /** A list of connected pavilion Nodes */
  nodes: Array<Pavilion>;
  /** Information about pagination in a connection. */
  pageInfo: PavilionConnectionPageInfo;
};

/** Edge between a Node and a connected pavilion */
export type PavilionConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected pavilion Node */
  node: Pavilion;
};

/** Page Info on the connected PavilionConnectionEdge */
export type PavilionConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Pavilion type and the pavilion type */
export type PavilionToPreviewConnectionEdge = Edge & OneToOneConnection & PavilionConnectionEdge & {
  __typename?: 'PavilionToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Pavilion;
...
/** Field Group */
export type Pavilion_Acfpavilionfields = AcfFieldGroup & {
  __typename?: 'Pavilion_Acfpavilionfields';
  benefitslider?: Maybe<Array<Maybe<Pavilion_Acfpavilionfields_Benefitslider>>>;
  contentrates?: Maybe<Scalars['String']['output']>;
  equipment?: Maybe<Array<Maybe<Pavilion_Acfpavilionfields_Equipment>>>;
  exampleslider?: Maybe<Array<Maybe<Pavilion_Acfpavilionfields_Exampleslider>>>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Выберите страницы, на которых объект будет скрыт. Для множественного выбора зажмите Ctrl. */
  hiddenon?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  ...
  mainproperties?: Maybe<Array<Maybe<Pavilion_Acfpavilionfields_Mainproperties>>>;
  mainslider?: Maybe<Array<Maybe<MediaItem>>>;
  maintitle?: Maybe<Scalars['String']['output']>;
  /** Номер позиции карточки объекта на странице павильонов */
  pavilionspriority?: Maybe<Scalars['Float']['output']>;
  ...
  titlerates?: Maybe<Scalars['String']['output']>;
  titlesimilarlounges?: Maybe<Scalars['String']['output']>;
};
...
export type Pavilion_Acfpavilionfields_Benefitslider = AcfFieldGroup & {
  __typename?: 'Pavilion_Acfpavilionfields_benefitslider';
  content?: Maybe<Scalars['String']['output']>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  image?: Maybe<MediaItem>;
...
/** Field Group */
export type Pavilion_Acfpavilionfields_Exampleslider = AcfFieldGroup & {
  __typename?: 'Pavilion_Acfpavilionfields_exampleslider';
  caption?: Maybe<Scalars['String']['output']>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  image?: Maybe<MediaItem>;
...
/** Field Group */
export type Pavilion_Acfpavilionfields_Mainproperties = AcfFieldGroup & {
  __typename?: 'Pavilion_Acfpavilionfields_mainproperties';
  content?: Maybe<Scalars['String']['output']>;
  excerpt?: Maybe<Scalars['String']['output']>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
...
/** Field Group */
export type Pavilion_Acfpavilionfields_Rates = AcfFieldGroup & {
  __typename?: 'Pavilion_Acfpavilionfields_rates';
  content?: Maybe<Scalars['String']['output']>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  label?: Maybe<Scalars['String']['output']>;
  ...
  properties?: Maybe<Array<Maybe<Pavilion_Acfpavilionfields_Rates_Properties>>>;
  time?: Maybe<Scalars['String']['output']>;
  unit?: Maybe<Scalars['String']['output']>;
};

/** Field Group */
export type Pavilion_Acfpavilionfields_Rates_Properties = AcfFieldGroup & {
  __typename?: 'Pavilion_Acfpavilionfields_rates_properties';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
...
export type RootMutation = {
  ...
  /** The createDressing mutation */
  createDressing?: Maybe<CreateDressingPayload>;
  /** The createEquipment mutation */
  createEquipment?: Maybe<CreateEquipmentPayload>;
  /** The createEvent mutation */
  createEvent?: Maybe<CreateEventPayload>;
  /** The createJournal mutation */
  createJournal?: Maybe<CreateJournalPayload>;
  /** The createLounge mutation */
  createLounge?: Maybe<CreateLoungePayload>;
  ...
  /** The deleteDressing mutation */
  deleteDressing?: Maybe<DeleteDressingPayload>;
  /** The deleteEquipment mutation */
  deleteEquipment?: Maybe<DeleteEquipmentPayload>;
  /** The deleteEvent mutation */
  deleteEvent?: Maybe<DeleteEventPayload>;
  /** The deleteJournal mutation */
  deleteJournal?: Maybe<DeleteJournalPayload>;
  /** The deleteLounge mutation */
  deleteLounge?: Maybe<DeleteLoungePayload>;
  ...
  /** The updateDressing mutation */
  updateDressing?: Maybe<UpdateDressingPayload>;
  /** The updateEquipment mutation */
  updateEquipment?: Maybe<UpdateEquipmentPayload>;
  /** The updateEvent mutation */
  updateEvent?: Maybe<UpdateEventPayload>;
  /** The updateJournal mutation */
  updateJournal?: Maybe<UpdateJournalPayload>;
  /** The updateLounge mutation */
  updateLounge?: Maybe<UpdateLoungePayload>;
...
/** The root mutation */
export type RootMutationCreateDressingArgs = {
  input: CreateDressingInput;
};
...
/** The root mutation */
export type RootMutationCreateJournalArgs = {
  input: CreateJournalInput;
};


/** The root mutation */
export type RootMutationCreateLoungeArgs = {
...
/** The root mutation */
export type RootMutationCreatePavilionArgs = {
  input: CreatePavilionInput;
};
...
/** The root mutation */
export type RootMutationDeleteDressingArgs = {
  input: DeleteDressingInput;
};
...
/** The root mutation */
export type RootMutationDeleteJournalArgs = {
  input: DeleteJournalInput;
};


/** The root mutation */
export type RootMutationDeleteLoungeArgs = {
  input: DeleteLoungeInput;
};
...
/** The root mutation */
export type RootMutationDeletePavilionArgs = {
  input: DeletePavilionInput;
};
...
/** The root mutation */
export type RootMutationUpdateDressingArgs = {
  input: UpdateDressingInput;
};
...
/** The root mutation */
export type RootMutationUpdateJournalArgs = {
  input: UpdateJournalInput;
};


/** The root mutation */
export type RootMutationUpdateLoungeArgs = {
  input: UpdateLoungeInput;
};
...
/** The root mutation */
export type RootMutationUpdatePavilionArgs = {
  input: UpdatePavilionInput;
};
...
export type RootQuery = {
  ...
  /** Connection between the RootQuery type and the journal type */
  allJournal?: Maybe<RootQueryToJournalConnection>;
  ...
  /** An object of the dressing Type.  */
  dressing?: Maybe<Dressing>;
  /**
   * A dressing object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  dressingBy?: Maybe<Dressing>;
  /** Connection between the RootQuery type and the dressing type */
  dressings?: Maybe<RootQueryToDressingConnection>;
  ...
  /** An object of the journal Type.  */
  journal?: Maybe<Journal>;
  /**
   * A journal object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  journalBy?: Maybe<Journal>;
  /** An object of the lounge Type.  */
  lounge?: Maybe<Lounge>;
  /**
   * A lounge object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  loungeBy?: Maybe<Lounge>;
  /** Connection between the RootQuery type and the lounge type */
  lounges?: Maybe<RootQueryToLoungeConnection>;
   ...
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  pavilionBy?: Maybe<Pavilion>;
  /** Connection between the RootQuery type and the pavilion type */
  pavilions?: Maybe<RootQueryToPavilionConnection>;
  /** A WordPress plugin */
  plugin?: Maybe<Plugin>;
...
/** The root entry point into the Graph */
export type RootQueryAllJournalArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToJournalConnectionWhereArgs>;
};
...
/** The root entry point into the Graph */
export type RootQueryDressingArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<DressingIdType>;
};


/** The root entry point into the Graph */
export type RootQueryDressingByArgs = {
  dressingId?: InputMaybe<Scalars['Int']['input']>;
  id?: InputMaybe<Scalars['ID']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
...
/** The root entry point into the Graph */
export type RootQueryDressingsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToDressingConnectionWhereArgs>;
};
...
export type RootQueryJournalArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<JournalIdType>;
};


/** The root entry point into the Graph */
export type RootQueryJournalByArgs = {
  id?: InputMaybe<Scalars['ID']['input']>;
...
/** The root entry point into the Graph */
export type RootQueryLoungeArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<LoungeIdType>;
};


/** The root entry point into the Graph */
export type RootQueryLoungeByArgs = {
  id?: InputMaybe<Scalars['ID']['input']>;
  loungeId?: InputMaybe<Scalars['Int']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
  uri?: InputMaybe<Scalars['String']['input']>;
};
...
/** The root entry point into the Graph */
export type RootQueryLoungesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToLoungeConnectionWhereArgs>;
};
...
/** The root entry point into the Graph */
export type RootQueryPavilionArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<PavilionIdType>;
};


/** The root entry point into the Graph */
export type RootQueryPavilionByArgs = {
  id?: InputMaybe<Scalars['ID']['input']>;
  pavilionId?: InputMaybe<Scalars['Int']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
  uri?: InputMaybe<Scalars['String']['input']>;
};
...
/** The root entry point into the Graph */
export type RootQueryPavilionsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToPavilionConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the dressing type */
export type RootQueryToDressingConnection = Connection & DressingConnection & {
  __typename?: 'RootQueryToDressingConnection';
  /** Edges for the RootQueryToDressingConnection connection */
  edges: Array<RootQueryToDressingConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Dressing>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToDressingConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToDressingConnectionEdge = DressingConnectionEdge & Edge & {
  __typename?: 'RootQueryToDressingConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Dressing;
...
/** Page Info on the &quot;RootQueryToDressingConnection&quot; */
export type RootQueryToDressingConnectionPageInfo = DressingConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToDressingConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToDressingConnection connection */
export type RootQueryToDressingConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Connection between the RootQuery type and the equipment type */
export type RootQueryToEquipmentConnection = Connection & EquipmentConnection & {
  __typename?: 'RootQueryToEquipmentConnection';
  /** Edges for the RootQueryToEquipmentConnection connection */
  edges: Array<RootQueryToEquipmentConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Equipment>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToEquipmentConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToEquipmentConnectionEdge = Edge & EquipmentConnectionEdge & {
...
/** Page Info on the &quot;RootQueryToEquipmentConnection&quot; */
export type RootQueryToEquipmentConnectionPageInfo = EquipmentConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToEquipmentConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the RootQuery type and the journal type */
export type RootQueryToJournalConnection = Connection & JournalConnection & {
  __typename?: 'RootQueryToJournalConnection';
  /** Edges for the RootQueryToJournalConnection connection */
  edges: Array<RootQueryToJournalConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Journal>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToJournalConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToJournalConnectionEdge = Edge & JournalConnectionEdge & {
  __typename?: 'RootQueryToJournalConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Journal;
...
/** Page Info on the &quot;RootQueryToJournalConnection&quot; */
export type RootQueryToJournalConnectionPageInfo = JournalConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToJournalConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToJournalConnection connection */
export type RootQueryToJournalConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Connection between the RootQuery type and the lounge type */
export type RootQueryToLoungeConnection = Connection & LoungeConnection & {
  __typename?: 'RootQueryToLoungeConnection';
  /** Edges for the RootQueryToLoungeConnection connection */
  edges: Array<RootQueryToLoungeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Lounge>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToLoungeConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToLoungeConnectionEdge = Edge & LoungeConnectionEdge & {
  __typename?: 'RootQueryToLoungeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Lounge;
...
/** Page Info on the &quot;RootQueryToLoungeConnection&quot; */
export type RootQueryToLoungeConnectionPageInfo = LoungeConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToLoungeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToLoungeConnection connection */
export type RootQueryToLoungeConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
export type RootQueryToPavilionConnection = Connection & PavilionConnection & {
  ...
  /** Edges for the RootQueryToPavilionConnection connection */
  edges: Array<RootQueryToPavilionConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Pavilion>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToPavilionConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToPavilionConnectionEdge = Edge & PavilionConnectionEdge & {
  __typename?: 'RootQueryToPavilionConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Pavilion;
...
/** Page Info on the &quot;RootQueryToPavilionConnection&quot; */
export type RootQueryToPavilionConnectionPageInfo = PageInfo & PavilionConnectionPageInfo & WpPageInfo & {
  __typename?: 'RootQueryToPavilionConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToPavilionConnection connection */
export type RootQueryToPavilionConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
export type SeoContentTypes = {
  ...
  dressing?: Maybe<SeoContentType>;
  equipment?: Maybe<SeoContentType>;
  event?: Maybe<SeoContentType>;
  journal?: Maybe<SeoContentType>;
...
/** Input for the updateDressing mutation. */
export type UpdateDressingInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the dressing object */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updateDressing mutation. */
export type UpdateDressingPayload = {
  __typename?: 'UpdateDressingPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  dressing?: Maybe<Dressing>;
...
/** Input for the updateJournal mutation. */
...
/** The payload for the updateJournal mutation. */
...
/** Input for the updateLounge mutation. */
export type UpdateLoungeInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the lounge object */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updateLounge mutation. */
export type UpdateLoungePayload = {
  __typename?: 'UpdateLoungePayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  lounge?: Maybe<Lounge>;
...
export type UpdatePavilionInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the pavilion object */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updatePavilion mutation. */
export type UpdatePavilionPayload = {
  __typename?: 'UpdatePavilionPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  pavilion?: Maybe<Pavilion>;
